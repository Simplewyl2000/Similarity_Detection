...
#            registers[i] = 0
	...
	out=len(DVMBasicMethodBlock.childs)
	indegree=len(DVMBasicMethodBlock.fathers)
	nodein_pro.append(out)
	nodein_pro.append(indegree)
	properity.append(nodein_pro)
	print out
	print indegree
	#raw_input("lalalalalals")
