...
def DetectConfig(request):
    return render(request, 'DetectResultHistory/DetectConfig.html')
...
@csrf_exempt
def History(request):
    return render(request, 'DetectResultHistory/History.html')
...
def DetectResult(request):
    return render(request, 'DetectResultHistory/DetectResult.html')
